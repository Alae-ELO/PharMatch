  ...
  if (!medication) {
    return (
      <div className="container mx-auto px-4 py-8 text-center">
        <h1 className="text-2xl font-bold mb-4">{t('medication_not_found')}</h1>
        <Link to="/medications">
          <Button variant="outline">{t('back_to_medications')}</Button>
        </Link>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
            ...
            <CardHeader>
              <div className="flex justify-between items-start">
                ...
                <Badge variant={medication.prescription ? 'warning' : 'success'}>
                  {medication.prescription ? t('prescription_required') : t('over_the_counter')}
                </Badge>
              </div>
            </CardHeader>
            <CardContent className="space-y-6">
              <div>
                <h3 className="text-sm font-medium text-gray-500 mb-2">{t('description')}</h3>
              ...
              {medication.prescription && (
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-amber-800">{t('prescription_required')}</h4>
                      <p className="text-sm text-amber-700">
                        {t('prescription_notice')}
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <Card className="mt-8">
            <CardHeader>
              <CardTitle>{t('pharmacy_availability')}</CardTitle>
            </CardHeader>
            <CardContent>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <Badge
                          ...
                          className="mt-1"
                        >
                          {pharmacy.inStock ? t('in_stock') : t('out_of_stock')}
                        </Badge>
                      </div>
                    </div>
        ...
        <div className="lg:col-span-1">
          <Card>
            <CardHeader>
              <CardTitle>{t('important_info')}</CardTitle>
            </CardHeader>
            <CardContent className="prose prose-sm">
              <p>{t('info_disclaimer')}</p>
              <ul className="list-disc pl-4 space-y-2">
                <li>{t('dosage')}</li>
                <li>{t('side_effects')}</li>
                <li>{t('interactions')}</li>
                <li>{t('contraindications')}</li>
              </ul>
